...
const TentsContext = ({ children }) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/homestays")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/farmhouses")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/villas")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/cottages")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/treehouses")
  ...
  useEffect(() => {
    ...
    if (sortAmenities.length > 0) {
      filteredItems = filteredItems.filter(
        (val) =>
          val.freeServices &&
          sortAmenities.some((amenity) => val.freeServices.includes(amenity)),
      );
    }
    if (ratings.length > 0) {
      filteredItems = filteredItems.filter((val) => {
        return (
          val.ratings.location && val.ratings.location >= parseFloat(ratings)
        );
      });
    }
    if (sortLocation.length > 0) {
      filteredItems = filteredItems.filter(
        (val) =>
          val.address.dist &&
          sortLocation.some((location) => val.address.dist.includes(location)),
      );
    }
  ...
  useEffect(() => {
    ...
    if (sortAmenities.length > 0) {
      filteredHotelsItems = filteredHotelsItems.filter(
        (val) =>
          val.freeServices &&
          sortAmenities.some((amenity) => val.freeServices.includes(amenity)),
      );
  ...
  useEffect(() => {
    ...
    if (sortAmenities.length > 0) {
      filteredHomestaysItems = filteredHomestaysItems.filter(
        (val) =>
          val.freeServices &&
          sortAmenities.some((amenity) => val.freeServices.includes(amenity)),
      );
  ...
  useEffect(() => {
    ...
    if (search) {
      filteredCampItems = filteredCampItems.filter(
        (stays) =>
          stays.address.dist.toLowerCase().includes(search.toLowerCase()) ||
          stays.campName.toLowerCase().includes(search.toLowerCase()) ||
          stays.address.tal.toLowerCase().includes(search.toLowerCase()) ||
  ...
  useEffect(() => {
    ...
    if (search) {
      filteredVillasItems = filteredVillasItems.filter(
        (stays) =>
          stays.address.dist.toLowerCase().includes(search.toLowerCase()) ||
          stays.campName.toLowerCase().includes(search.toLowerCase()) ||
          stays.address.tal.toLowerCase().includes(search.toLowerCase()) ||
  ...
  useEffect(() => {
    ...
    if (search) {
      filteredApartmentsItems = filteredApartmentsItems.filter(
        (stays) =>
          stays.address.dist.toLowerCase().includes(search.toLowerCase()) ||
          stays.campName.toLowerCase().includes(search.toLowerCase()) ||
          stays.address.tal.toLowerCase().includes(search.toLowerCase()) ||
  ...
  useEffect(() => {
    ...
    if (search) {
      filteredFarmhousesItems = filteredFarmhousesItems.filter(
        (stays) =>
          stays.address.dist.toLowerCase().includes(search.toLowerCase()) ||
          stays.campName.toLowerCase().includes(search.toLowerCase()) ||
          stays.address.tal.toLowerCase().includes(search.toLowerCase()) ||
  ...
  useEffect(() => {
    ...
    if (search) {
      filteredTreeHousesItems = filteredTreeHousesItems.filter(
        (stays) =>
          stays.address.dist.toLowerCase().includes(search.toLowerCase()) ||
          stays.campName.toLowerCase().includes(search.toLowerCase()) ||
          stays.address.tal.toLowerCase().includes(search.toLowerCase()) ||
  ...
  useEffect(() => {
    ...
    if (search) {
      filteredCottagesItems = filteredCottagesItems.filter(
        (stays) =>
          stays.address.dist.toLowerCase().includes(search.toLowerCase()) ||
          stays.campName.toLowerCase().includes(search.toLowerCase()) ||
          stays.address.tal.toLowerCase().includes(search.toLowerCase()) ||
